...
<form method="post" action="/estudiante/registro">
    ...
    Ingrese Fecha de nacimiento :<input type="date" name="Fecha de nacimiento" placeholder="Ingrese su fecha de nacimiento"><br>
    ...
    Ingrese Contraseña:<input type="text" name="Password" placeholder="Ingrese contraseña"><br>
